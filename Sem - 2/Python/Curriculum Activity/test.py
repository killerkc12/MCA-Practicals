...
class StudentApp(tk.Tk):  
    def __init__(self):  
        ...
        self.configure(background='#f50057')
        self.geometry("800x650+351+174")  
        self.lblTitle = tk.Label(self, text="Student Management System", font=("Helvetica", 20), fg="black")  
        self.lblFName = tk.Label(self, text="Enter FirstName:", font=("Helvetica", 10), fg="black")  
        self.lblLName = tk.Label(self, text="Enter LastName:", font=("Helvetica", 10), fg="black")  
        self.lblContactNo = tk.Label(self, text="Enter Contact No:", font=("Helvetica", 10), fg="black")  
        self.lblCity = tk.Label(self, text="Enter City:", font=("Helvetica", 10),fg="black")  
        self.lblState = tk.Label(self, text="Enter State:", font=("Helvetica", 10), fg="black")  
        self.lblDOB = tk.Label(self, text="Choose Date of Birth:", font=("Helvetica", 10), fg="black")  
        self.lblSelect = tk.Label(self, text="Please select one record below to update or delete", font=("Helvetica", 15,BOLD), fg="black")  
        self.lblSearch = tk.Label(self, text="Please Enter Roll No:",font=("Helvetica", 10), fg="black")  
        ...
        self.btn_register = tk.Button(self, text="Register", font=("Helvetica", 11), bg="blue", fg="white",  
        command=self.register_student)  
        self.btn_update = tk.Button(self,text="Update",font=("Helvetica",11),bg="blue", fg="white",command=self.update_student_data)  
        self.btn_delete = tk.Button(self, text="Delete", font=("Helvetica", 11), bg="blue", fg="white",  
        command=self.delete_student_data)  
        self.btn_clear = tk.Button(self, text="Clear", font=("Helvetica", 11), bg="blue", fg="white",  
        command=self.clear_form)  
        self.btn_show_all = tk.Button(self, text="Show All", font=("Helvetica", 11), bg="blue", fg="white",  
        command=self.load_student_data)  
        self.btn_search = tk.Button(self, text="Search", font=("Helvetica", 11), bg="blue", fg="white",  
        command=self.show_search_record)  
        self.btn_exit = tk.Button(self, text="Exit", font=("Helvetica", 16), bg="red", fg="white",command=self.exit)  
        ...
        self.lblTitle.place(x=150, y=30, height=25, width=500)  
        ...
        self.lblState.place(x=100, y=187, height=23, width=150)  
        self.lblDOB.place(x=100, y=217, height=23, width=150)  
        self.lblSelect.place(x=100, y=280, height=23, width=600)  
        self.lblSearch.place(x=100, y=560, height=23, width=150)  
        self.entFName.place(x=400, y=72, height=21, width=186)  
        self.entLName.place(x=400, y=100, height=21, width=186)  
        self.entContact.place(x=400, y=129, height=21, width=186)  
        self.entCity.place(x=400, y=158, height=21, width=186)  
        self.entState.place(x=400, y=188, height=21, width=186)  
        self.calDOB.place(x=400, y=218, height=21, width=186)  
        self.entSearch.place(x=310, y=560, height=21, width=186)  
        self.btn_register.place(x=100, y=245, height=25, width=76)  
        self.btn_update.place(x=180, y=245, height=25, width=76)  
        self.btn_delete.place(x=260, y=245, height=25, width=76)  
        self.btn_clear.place(x=338, y=245, height=25, width=76)  
        self.btn_show_all.place(x=420, y=245, height=25, width=76)  
